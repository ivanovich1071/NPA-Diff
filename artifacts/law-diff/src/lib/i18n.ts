...
const translations = {
  ru: {
    ...
    inputMethodUrl: 'Ссылка pravo.by / etalonline.by / nalog.gov.by',
    pasteTextPlaceholder: 'Вставьте текст документа...',
    urlPlaceholder: 'https://pravo.by/document/?guid=..., https://etalonline.by/... или https://nalog.gov.by/tax_code/...',
  ...
  be: {
    ...
    inputMethodUrl: 'Спасылка pravo.by / etalonline.by / nalog.gov.by',
    pasteTextPlaceholder: 'Устаўце тэкст дакумента...',
    urlPlaceholder: 'https://pravo.by/document/?guid=..., https://etalonline.by/... або https://nalog.gov.by/tax_code/...',
